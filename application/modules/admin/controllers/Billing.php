	...
	public function add(){
        ...
        if (isPostBack()) {
			...
			if ($this->form_validation->run() == false) {
				...
				$data['pdf_data'] = $this->Billing_mod->Billing_details(ID_encode($result));
				$message = 'Hello Mr. '.$data['pdf_data']->cnt_name.', Your Invoice is Created Successfully';
				$this->smsapi($data['pdf_data']->cnt_number, $message);
				// pr($data['pdf_data']->cnt_name); die;
