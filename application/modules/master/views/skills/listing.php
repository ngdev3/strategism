                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?=get_flashdata();?>
									...
									<a href="<?php echo base_url('master/skills/add');?>" id="back-btn" class="btn cur-p btn-primary pull-right">ADD</a>
...
<script>
        ...
        if(id !=''){
            ...
            jConfirm('Are you sure?', 'Confirmation Dialog', function(r) {
                if(r)
                {
                    $.ajax({
                        type:"POST",
                        url:"<?php echo site_url("master/skills/delete_city") ?>",
                         data:csrf_name+'='+csrf_token+'&id='+id,
                        success:function(data){
                            
                            window.location.href = "<?= base_url() ?>master/skills";
                        }
                    });
                }
            });
    ...
    table.dataTable({
        ...
        "ajax": {
            url: "<?php echo base_url(); ?>/master/skills/view_all?<?php echo $QUERY_STRING; ?>", // json datasource
            type: "post",
...
"orderable": false,  // set orderable for selected columns
    ...
    $(document).ready(function() {  
     ...
     $(".custom_filter").on("change",function(){ 
        ...
        if(status == 'none')
        {
           window.location.href= "<?php echo base_url('master/skills'); ?>" ;
        }
