            ...
            <div class="dashboard_box_white">
                 <div class="widget">
                            ...
                            <div class="mini-stats ">
								...
								<h3><?=@$total_feedback_responses[0]->total_response?></h3>
								<?php } else { ?>
								<h3>0</h3>
								<?php } ?>
                            </div>
            ...
            <div class="dashboard_box_white">
                 <div class="widget">
                            ...
                            <div class="mini-stats ">
                                ...
                                <p><i class="fa  fa-arrow-up up"></i> units</p>
                                <?php if($total_units) { ?>
								<h3><?=@$total_units?></h3>
								<?php } else { ?>
								<h3>0</h3>
        ...
        <div class="col-md-4">
			...
			?>
                 <div class="widget">
                    <div class="widget-controls">
                      ...
                      <div class="dashboard_heading"><?=($nps_key == 'Global Net Promoter Score')?"Global Endorsement Scores":""?></div>
                      <div class="dashboard_md_50">
                        <div class="dashboard_avtart_main">
                            <div class="dashboard-avtar-img">
                                <img src="<?php echo base_url();?>assets/images/dashboard_avtar_green.png"/>
                            ...
                            <div class="dashboard_bulb_txt"><div class="dashboard_bulb_txt_display"><img src="<?php echo base_url();?>assets/images/dashboard_bulb_icon.png"/></div><div class="dashboard_bulb_txt_display"><?=$nps_val['yes_count']?></div></div>
                        </div>
                        </div>
                        <div class="dashboard_avtart_main">
                             <div class="dashboard-avtar-img">
                            ...
                            <div class="dashboard_bulb_txt"><div class="dashboard_bulb_txt_display"><img src="<?php echo base_url();?>assets/images/dashboard_bulb_icon.png"/> </div><div class="dashboard_bulb_txt_display"><?=$nps_val['not_sure_count']?> </div></div>
                        </div>
                        </div>
                        <div class="dashboard_avtart_main">
                             <div class="dashboard-avtar-img">
                            ...
                            <div class="dashboard_bulb_txt"><div class="dashboard_bulb_txt_display"><img src="<?php echo base_url();?>assets/images/dashboard_bulb_icon.png"/></div><div class="dashboard_bulb_txt_display"><?=$nps_val['no_count']?></div></div>
                        </div>
                        </div>
                      </div>
			...
			<?php }}else{ ?>
                    ...
                    <div class="widget-controls">
                      ...
                      <div class="dashboard_heading">Global Endorsement Score</div>
                      <div class="dashboard_md_50">
                        <div class="dashboard_avtart_main">
                            <div class="dashboard-avtar-img">
                                <img src="<?php echo base_url();?>assets/images/dashboard_avtar_green.png"/>
            ...
            <div class="dashboard_box_white1">
                 <div class="widget">
						 ...
						 <?php  
                                                        ...
                                                        if(!empty($fetch_unit_wise_rating)) {
                                                        foreach($fetch_unit_wise_rating as $key => $val){
                                                            $s[]   =   $val['happy_p'];
                                                        }
                                                        array_multisort($s,SORT_DESC,$fetch_unit_wise_rating);    
                                                        foreach($fetch_unit_wise_rating as $unit_wisekey => $unit_wise_val){
							$happy=round($unit_wise_val['happy_p']);
							$neutral=round($unit_wise_val['neutral_p']);
							$unhappy=round($unit_wise_val['unhappy_p']);
							
                                                        $total = $happy + $unhappy + $neutral; 
                                                        if($total == 101){$neutral = $neutral-1;}else if($total == 99){$neutral = $neutral+1;}
						 ...
						 ?>	
						   <div class="dashboard_full_strip">
                            ...
                            <div class="dashboard_md_60">
                                ...
                                <div class="dashboard_bulb_main">
                            <div class="dashboard_bulb_icon"><img src="<?php echo base_url();?>assets/images/dashboard_bulb_icon.png"></div>
                            <div class="dashboard_bulb_txt12"><?=$unit_wise_val['total_response']?></div>
                        </div>
                        </div>
                            </div>
      ...
      <div class="col-md-4">
            <div class="dashboard_box_white1">
                 <div class="widget">				 
                            ...
                            <div class="dashboard_heading1">top 5 : <span> Unit wise Endorsement Scores</span></div> 
							<?php
                                                        
                                                        if(!empty($fetch_unit_wise_rating_for_nps)) { 
                                                            $s1 =    array();
                                                        
                                                        foreach($fetch_unit_wise_rating_for_nps as $key => $val){
                                                            $s1[]   =   $val['yes_p'];
                                                        }
                                                        
                                                        array_multisort($s1,SORT_DESC,$fetch_unit_wise_rating_for_nps);
                                                        foreach($fetch_unit_wise_rating_for_nps as $nps_key => $nps_val) {							
							$nps_happy=round($nps_val['yes_p']);
							$nps_neutral=round($nps_val['not_sure_p']);
							$nps_unhappy=round($nps_val['no_p']);
                                                        
                                                        $total = $nps_happy + $nps_unhappy + $nps_neutral; 
                                                        if($total == 101){$nps_neutral = $nps_neutral-1;}else if($total == 99){$nps_neutral = $nps_neutral+1;}
                            ...
                            <div class="dashboard_md_60">
                                ...
                                <div class="dashboard_bulb_main">
                            <div class="dashboard_bulb_icon"><img src="<?php echo base_url();?>assets/images/dashboard_bulb_icon.png"></div>
                            <div class="dashboard_bulb_txt12"><?=$nps_val['total_response']?></div>
                        </div>
                        </div>
                            </div>
        ...
        <div class="col-md-4">
          <div class="dashboard_box_white1">
            <div class="widget">
              <div class="widget-controls">                               
                <span class="dashboard_sort">
                  <i class="fa fa-caret-left rating-slide-prev"></i>
                  <i id="go-right" class="fa fa-caret-right rating-slide-next"></i>
                </span>
                <span class="refresh-content"><i class="fa fa-refresh"></i></span>
              </div><!-- Widget Controls -->	
							
              <div class="dashboard_heading1">Feedback Set :
              <?php 
                if (empty($feedback_set) === false) {
                  echo '<span id="fdb_set_name">';
                  echo @$feedback_set[0]['feedback_set']->feedback_set;
                  echo '</span>';
                } else {
                  echo '</div>';
                  echo '<div class="rating-heading">No Feedback Found!</div>';
                }
                echo '<div class="div-slider">';
                echo '<ul>';
                $class =  "";
                if (empty($feedback_set) === false) { $l=0;
                  
                  foreach($feedback_set as $feedback_key => $feedback_val) {
                      if($l == 0){$class= "asd";}else{ $class="";}
                                $happy   = 0;
                                $neutral = 0;
                                $unhappy = 0;
                    ...
                    $total_response = ($count_feedback_resp > 0) ? $count_feedback_resp : 0;

                    $happy_p   = 0;
                    $neutral_p = 0;
                    $unhappy_p = 0;

    								if ($feedback_resp !== false) {
                  ...
                  <li class="<?= $class?>" >
								    ...
								    <?php  
                      foreach($feedback_val['questions'] as $ques_key => $ques_val) { 
                    ?>
                        <div class="dashboard_full_strip_12_rate">
                          <div class="dashboard_md_60">
                              <div class="dashboard_edit_icon">
                                <img src="<?php echo base_url();?>assets/images/dashboard_edit_icon.png"/>
                              </div>
                              <div class="dashboard_edit_icon_txt"><?=$ques_val->question?></div>
                          </div>
                          <?php 
                          $question_responses	=	$this->dashboard_mod->get_question_response($ques_val->id,$ques_val->feedback_set_id); 
					                $f_happy   = 0;
                          $f_unhappy = 0;
                          $f_neutral = 0;
...
<script src="<?=base_url()?>assets/js/jquery.rateItSlider.js"></script>
