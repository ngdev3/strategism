                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="bgc-white bd bdrs-3 p-20 mB-20">
                                    ...
                                    <a href="<?=base_url()?>master/consultant/" id="back-btn" class="btn cur-p btn-primary pull-right">Back</a>
                                    <br><br>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th class="table_bg" scope="col">Client Name</th>
                                                <td scope="col"><?php echo $result->client_name;?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <th class="table_bg" scope="col">Term Days</th>
                                                <td scope="col"><?php echo $result->term_days.' Days';?></td>
                                            </tr>
