                        ...
                        <div class="row">
                            <div class="masonry-item col-md-12"> 
                                <div class="bgc-white p-20 bd">
                                    <h6 class="c-grey-900">Add Project Duration</h6>
                                     <?=get_flashdata();?>
                                    <div class="mT-30">
                                        <?php echo form_open_multipart('', array('class' => '', 'id' => 'ciatyform_id',)); ?>
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputEmail4">Add Project Duration*</label>
                                                    <!-- <input type="text" name="city_name" value="<?php echo set_value('city_name') ?>"   class="form-control"  placeholder="City Name"> -->
                                                   <?php  $name = @$result->duration;
                                                    $postvalue = @$_POST['duration'];
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                                    echo form_input(array('name' => 'duration','type'=>'text','maxlength'=>'150', 'class' => 'form-control', 'id' => 'cate_id', 'placeholder' => 'Add Project Duration', 'value' => !empty($postvalue) ? $postvalue : $name ,'onkeyup'=>'validate_character(this)'));
                                                 ?>
                                            ...
                                            <div class="form-group">
                                                <div class="checkbox checkbox-circle checkbox-info peers ai-c text-center">
                                                   ...
                                                   <a href="<?php echo base_url('master/project_duration/');?>"><button type="button" class="btn btn-primary"> Cancel </button></a>
